const starterSheets = () => [
	{
		...
		defaultRows: [
			['Statement Set', 'Updated at', 'Description', 'Note', 'Statements Begin Here'],
			[
				'California 100',
				new Date().toLocaleString(),
				"Rogers's 100 statement set, historically in piles of 5,8,12,16,18,16,12,8,5",
				'',
	...
	{
		title: 'Sorts',
		defaultRows: [['Statement Set', 'Subject', 'Sorted At', 'Note', 'Statement Bins Begin Here']]
	}
];

export default starterSheets;
